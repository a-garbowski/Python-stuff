...
class AlienInvasion():
    ...
    def __init__(self):
        ...
        #Utworzenie egzemplarza przeznaczonego do przechowywania danych statystycznych gry
    ...
    def _check_events(self):
        """Reackja na zdarzenia generowane przez klawiaturę i mysz."""
    ...
    def _start_game(self):
        """Rozpoczęcie nowej gry po kliknięciu klawisza G przez użytkownika."""
        #Wyzerowanie danych statystycznych gry.
        self.stats.reset_stats()
        self.stats.game_active = True
    ...
    def _ship_hit(self):
        ...
        if self.stats.ships_left > 0:
            #Zmniejszenie wartości przechowywanej w ships_left i uaktualinenie tablicy wyników.
